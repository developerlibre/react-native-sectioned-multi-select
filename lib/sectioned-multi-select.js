...
class SectionedMultiSelect extends PureComponent {
  static propTypes = {
    ...
    extraSearchKey: PropTypes.string,
    shortDisplayKey: PropTypes.string,
    uniqueKey: PropTypes.string.isRequired,
    subKey: PropTypes.string,
    onSelectedItemsChange: PropTypes.func.isRequired,
    onRemoveAll: PropTypes.func,
    onAfterItemRemove: PropTypes.func,
    ...
    removeComponent: PropTypes.object,
  ...
  _filterItems = (searchTerm) => {
    ...
    items.forEach((item) => {
      ...
      if (
        regex.test(this.getProp(item, displayKey))
        || regex.test(this.getProp(item, extraSearchKey))
      ) {
      ...
      if (item[subKey]) {
        ...
        item[subKey].forEach((sub) => {
          if (
            regex.test(this.getProp(sub, displayKey))
            || regex.test(this.getProp(sub, extraSearchKey))
          ) {
  ...
  _removeItem = (item) => {
    ...
    onAfterItemRemove && onAfterItemRemove(newItems);
  }
